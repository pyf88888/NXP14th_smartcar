...
void My_ENC_InitPin(uint8_t enc_num)  //ENC管脚初始化
{
    ...
    switch(enc_num)//选择ENC模块
    {
        case 1:    //ENC1模块
        {
            ...
            IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_10_XBAR1_IN22,1U); //GPIO_AD_B0_10 配置为 XBAR1_IN22        G13   
            IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_09_XBAR1_IN21,1U); //GPIO_AD_B0_09 配置为 XBAR1_IN21        F14                                         
            IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_00_XBAR1_INOUT14,1U); //GPIO_AD_B0_00 配置为 XBAR1_INOUT14  M14     
        ...
        case 2:    //ENC2模块
        {
//            IOMUXC_SetPinMux(IOMUXC_GPIO_SD_B0_02_XBAR1_INOUT06,1U); //GPIO_AD_B0_02 配置为 XBAR1_INOUT06   J1
            IOMUXC_SetPinMux(IOMUXC_GPIO_SD_B0_04_XBAR1_INOUT08,1U); //GPIO_AD_B0_04 配置为 XBAR1_INOUT08   H2                                         
            IOMUXC_SetPinMux(IOMUXC_GPIO_SD_B0_05_XBAR1_INOUT09,1U); //GPIO_AD_B0_05 配置为 XBAR1_INOUT09   J2
...
//            IOMUXC_SetPinMux(IOMUXC_GPIO_B0_12_XBAR1_INOUT10,1U); //        C10  用之前确保没有当作别的用途
            IOMUXC_SetPinMux(IOMUXC_GPIO_B1_02_XBAR1_INOUT16,1U); //        C11  用之前确保没有当作别的用途                                       
            IOMUXC_SetPinMux(IOMUXC_GPIO_B1_01_XBAR1_INOUT15,1U); //        B11   用之前确保没有当作别的用途 
...
void My_ENC_Init(ENC_Type *base)  
{
    ...
    else if(base == ENC2) //ECL
    {
        ...
        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout08, kXBARA1_OutputEnc2PhaseAInput);//H2  A相
        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout09, kXBARA1_OutputEnc2PhaseBInput);//J2  B相或者方向
//        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout06, kXBARA1_OutputEnc2Index);      //J1  Z相
    }
    else if(base == ENC3)
    {
...
//        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout11, kXBARA1_OutputEnc3Index);      //D10    Z相
    ...
    else if(base == ENC4)
    {
        ...
        /*将单片机引脚连接到ENC2的内部触发信号上*/
        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout16, kXBARA1_OutputEnc4PhaseAInput);//C11   A相
        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout15, kXBARA1_OutputEnc4PhaseBInput);//B11   B相或者方向
